...
BLOG_AUTHOR = "Farley Lai"  # (translatable)
BLOG_TITLE = "A Fuzzy Philosopher"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://farley.futuresight.io/"
